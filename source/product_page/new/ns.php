...
<body>
    <div class="container">
        <h1 class="page-title">Etalase Setelan New</h1>   <!-- JUDUL: perlu diubah setiap page -->
        ...
        $sql = "SELECT 
                ...
                WHERE
                    kategori.nama_kategori = 'Setelan' -- < Perlu di Ubah >
                AND
                    jenis.nama_jenis = 'New'";
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>Tidak ada data produk untuk kategori Setelan dan jenis New.</p>";
        }
