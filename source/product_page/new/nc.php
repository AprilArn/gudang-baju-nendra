...
<body>
    <div class="container">
        <h1 class="page-title">Etalase Celana New</h1>   <!-- JUDUL: perlu diubah setiap page -->
        ...
        $sql = "SELECT 
                ...
                WHERE
                    kategori.nama_kategori = 'Celana' -- < Perlu di Ubah >
                AND
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>Tidak ada data produk untuk kategori Celana dan jenis New.</p>";
        }
